...
<body>
    ...
    <div class="content">
        <div class="profile-card">
            ...
            <div class="profile-info"><span>ID:</span> <b><%= recipient.getId() %></b></div>
            <div class="profile-info"><span>Gender:</span> <b><%= recipient.getGender() %></b></div>
            <div class="profile-info"><span>Date of Birth:</span> <b><%= recipient.getDateofbirth() %></b></div>
            <div class="profile-info"><span>Contact:</span> <b><%= recipient.getContact() %></b></div>
            <div class="profile-info"><span>Address:</span> <b><%= recipient.getLocation() %></b></div>
            <div class="profile-info"><span>Status:</span> <b><%= recipient.getStatus() %></b></div>
