<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.klef.jfsd.donation.model.Logistic"%>
	
<%@ taglib uri="jakarta.tags.core" prefix="c" %>
<% 
Logistic logistic = (Logistic) session.getAttribute("logistic");
if(logistic==null)
{
...
<body>
    ...
    <div class="center-container">
        <div class="card">
			<h3 align="center">Welcome,<%=logistic.getName()%></h3>
			<p>"The heart of every donation lies in the logistics that make it reach those in need."</p>
